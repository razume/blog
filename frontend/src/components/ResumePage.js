    ...
    <div>
      <div>
        ...
        <div className="resume-experience">
          ...
          <ul style={{ listStyleType: "none" }}>
            <li style={{ fontWeight: "bold" }}>
              Software Development Intern |<span style={styles.jobSpan}>
            ...
            <li style={{ fontWeight: "bold" }}>
              Financial Assistant |<span style={styles.jobSpan}>
        ...
        <div>
          ...
          <ul style={{ listStyleType: "none" }}>
            <li style={{ fontWeight: "bold" }}>
              Fullstack Acamdemy |<span style={styles.jobSpan}>
                {" "}Oct 2019 - May 2020
              </span>
              <ul>
                <li style={styles.nestedBullet}>
            ...
            <li style={{ fontWeight: "bold" }}>
              Florida State University |<span style={styles.jobSpan}>
